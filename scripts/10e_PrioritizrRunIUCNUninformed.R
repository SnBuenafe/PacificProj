...
## Target 100% (0 - 1) ##
###############################
PRIORITIZR_IUCN_target100_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                  commercial_targetfile = "outputs/final_features/08c_targets/01_Target100/uninformed/target_commercialuninformed.rds",
                                                  bycatch_targetfile = "outputs/final_features/08c_targets/01_Target100/uninformed/target_bycatchIUCNuninformed.rds",
                                                  commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                  bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                  climate_scenario = "uninformed",
                                                  outdir = "outputs/prioritizr_run/Uninformed/IUCN/01_Target100/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target100.pdf")
###############################
## Target 90% (0.1 - 0.9) ##
###############################
PRIORITIZR_IUCN_target90_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                             commercial_targetfile = "outputs/final_features/08c_targets/02_Target90/uninformed/target_commercialuninformed.rds",
                                                             bycatch_targetfile = "outputs/final_features/08c_targets/02_Target90/uninformed/target_bycatchIUCNuninformed.rds",
                                                             commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                             bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                             climate_scenario = "uninformed",
                                                             outdir = "outputs/prioritizr_run/Uninformed/IUCN/02_Target90/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target90.pdf")
###############################
## Target 80% (0.1 - 0.8) ##
###############################
PRIORITIZR_IUCN_target80_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/03_Target80/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/03_Target80/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/03_Target80/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target80.pdf")
###############################
## Target 70% (0.1 - 0.7) ##
###############################
PRIORITIZR_IUCN_target70_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/04_Target70/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/04_Target70/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/04_Target70/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target70.pdf")
###############################
## Target 60% (0.1 - 0.6) ##
###############################
PRIORITIZR_IUCN_target60_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/05_Target60/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/05_Target60/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/05_Target60/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target60.pdf")
###############################
## Target 50% (0.1 - 0.5) ##
###############################
PRIORITIZR_IUCN_target50_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/06_Target50/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/06_Target50/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/06_Target50/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target50.pdf")
###############################
## Target 40% (0.1 - 0.4) ##
###############################
PRIORITIZR_IUCN_target40_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/07_Target40/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/07_Target40/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/07_Target40/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target40.pdf")
###############################
## Target 30% (0.1 - 0.3) ##
###############################
PRIORITIZR_IUCN_target30_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/08_Target30/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/08_Target30/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/08_Target30/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target30.pdf")
###############################
## Target 20% (0.1 - 0.2) ##
###############################
PRIORITIZR_IUCN_target20_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/09_Target20/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/09_Target20/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/09_Target20/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target20.pdf")
###############################
## Target 10% (0 - 0.1) ##
###############################
PRIORITIZR_IUCN_target10_uninformed_run01 <- prioritizr_run(cost_file = "outputs/cost_layer/large_medium/costlayer.rds",
                                                            commercial_targetfile = "outputs/final_features/08c_targets/10_Target10/uninformed/target_commercialuninformed.rds",
                                                            bycatch_targetfile = "outputs/final_features/08c_targets/10_Target10/uninformed/target_bycatchIUCNuninformed.rds",
                                                            commercial_file = "outputs/final_features/07c_100perc/commercialuninformed_100percentile.rds",
                                                            bycatch_file = "outputs/final_features/07c_100perc/bycatchIUCNuninformed_100percentile.rds",
                                                            climate_scenario = "uninformed",
                                                            outdir = "outputs/prioritizr_run/Uninformed/IUCN/10_Target10/")
# Plotting
...
ggsave("pdfs/solutions/IUCN/Uninformed_Solutions_Target10.pdf")
