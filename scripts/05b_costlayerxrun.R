...
source("scripts/05a_costlayer.R")

########################################
# RUNNING THE FUNCTION #
########################################
COST_all <-  cost_pu(input = "inputs/rasterfiles/Costlayer/02-epipelagic_Cost_Raster_Sum.tif",
                  pu_shp = "inputs/shapefiles/PacificABNJGrid_05deg/PacificABNJGrid_05deg.shp",
                  outdir = "outputs/cost_layer/all/",
                  layer = "all",
                  stack_num = NA
)

# running using just large pelagics
COST_large <- cost_pu(input = "inputs/rasterfiles/CostLayer/Cost_RasterStack_byFunctionalGroup.grd",
                  pu_shp = "inputs/shapefiles/PacificABNJGrid_05deg/PacificABNJGrid_05deg.shp",
                  outdir = "outputs/cost_layer/large/",
                  layer = "pelagics",
                  stack_num = 19
)

# running using just medium pelagics
COST_medium <- cost_pu(input = "inputs/rasterfiles/CostLayer/Cost_RasterStack_byFunctionalGroup.grd",
                      pu_shp = "inputs/shapefiles/PacificABNJGrid_05deg/PacificABNJGrid_05deg.shp",
                      outdir = "outputs/cost_layer/medium/",
                      layer = "pelagics",
                      stack_num = 14
)

# running 
COST_largexmedium <- cost_pu(input = "inputs/rasterfiles/CostLayer/Cost_RasterStack_byFunctionalGroup.grd",
                      pu_shp = "inputs/shapefiles/PacificABNJGrid_05deg/PacificABNJGrid_05deg.shp",
                      outdir = "outputs/cost_layer/large_medium/",
                      layer = "pelagics",
                      stack_num = c(14,19)
)
...
ggsave("pdfs/CostLayer_All.pdf", width = 20, height = 10, dpi = 300)
...
ggsave("pdfs/CostLayer_Large.pdf", width = 20, height = 10, dpi = 300)
...
ggsave("pdfs/CostLayer_Medium.pdf", width = 20, height = 10, dpi = 300)
...
ggsave("pdfs/CostLayer_LargexMedium.pdf", width = 20, height = 10, dpi = 300)
...
ggsave("pdfs/CostLayers_Compiled.pdf", width = 20, height = 10, dpi = 300)
