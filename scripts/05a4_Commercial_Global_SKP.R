...
ggsave("outputs/05_Commercial/05a_GAMPlots/05a4_SKP/SKP_BestModel.pdf", width = 15, height = 10, dpi = 600)
...
p <- PlotMap(df, "Preds2")
p
ggsave("outputs/05_Commercial/05a_GAMPlots/05a4_SKP/SKP_map_presence.png", p, dpi = 600)
