...
```{r child = file.path("Chapter1_v2.Rmd")}
```

\newpage

```{r child = file.path("Chapter2_v2.Rmd")}
```
...
```{r child = file.path("Chapter5_v2.Rmd")}
```
...
```{r child = file.path("Chapter6_v2.Rmd")}
```

\newpage

```{r child = file.path("Chapter7_v2.Rmd")}
```