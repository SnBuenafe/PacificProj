...
```{r eval = TRUE, echo = TRUE, message = FALSE, fig.height = 8, fig.width = 10, fig.align = 'center'}
...
summary
```
```{r eval = TRUE, echo = FALSE, message = FALSE, results = FALSE, fig.height = 8, warning = FALSE}
library(patchwork)
source("scripts/12e_Stat_fKappaCorrplot.R")
source('scripts/12g_Stat_fCreateCircBarPlot.R')
