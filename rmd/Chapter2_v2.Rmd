...
First, we compiled a list of bycatch reported in the Pacific ABNJ. Then, we extracted their **IUCN** distribution. These polygons are from the IUCN Red List, showing the known ranges of the species (IUCN Red List, 2021).
